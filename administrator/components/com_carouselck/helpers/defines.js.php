...
<script>
	var CAROUSELCK = {
		...
		, ADMIN_URL : '<?php echo JUri::root(true) ?>/administrator/index.php?option=com_carouselck'
		, FRONT_URL : '<?php echo JUri::root(true) ?>/index.php?option=com_carouselck'
		, BASE_URL : '<?php echo JUri::base(true) ?>/index.php?option=com_carouselck'
	};
</script>