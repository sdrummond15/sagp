...
class CKFof {
	...
	static protected $environment = 'com_carouselck'; // for joomla only

	static protected $input;

	public static function loadHelper($name) {
		require_once(CAROUSELCK_PATH . '/helpers/ck' . $name . '.php');
	}
...
//			, $db->quoteName('profile_key') . ' = ' . $db->quote('custom.%')
	...
	public static function getModel($modelName, $classPrefix = 'Carouselck') {
