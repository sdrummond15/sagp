...
class CKInterface extends \stdClass {
	...
	public function __construct($properties = null) {
		$this->imagespath = CAROUSELCK_MEDIA_URI . '/images';
	}
	...
	<div class="ckrow">
		...
		<input type="text" id="<?php echo $prefix; ?>textgfont" name="<?php echo $prefix; ?>textgfont" class="<?php echo $prefix; ?> cktip" onchange="clean_gfont_name(this);" title="<?php echo CKText::_('CK_GFONT_DESC'); ?>" style="max-width:none;width:250px;" />
