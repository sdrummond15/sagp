...
class CKBrowse {
	...
	public static function getItemsList($type = 'image') {
		...
		$folder = $input->get('folder', '', 'string') ? '/' . trim($input->get('folder', '', 'string'), '/') : '/' . trim(JComponentHelper::getParams('com_carouselck')->get('imagespath', 'images/carouselck'), '/');
		...
		// no folder filtering 
		if (JComponentHelper::getParams('com_carouselck')->get('imagespathexclusive', '0') == '0') {
	...
	public static function ajaxAddPicture() {
		...
		$imgpath = $input->get('path', '', 'string') ? '/' . trim($input->get('path', '', 'string'), '/') . '/' : '/' . trim(JComponentHelper::getParams('com_carouselck')->get('imagespath', 'images/carouselck'), '/') . '/';
