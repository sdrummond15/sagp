...
$doc->addStylesheet(CAROUSELCK_MEDIA_URI . '/assets/ckbrowse.css');
...
<script type="text/javascript">
	...
	var CAROUSELCK_MEDIA_URI = '<?php echo CAROUSELCK_MEDIA_URI ?>';
	var CAROUSELCK_ADMIN_URL = '<?php echo CAROUSELCK_ADMIN_URL ?>';
	var CAROUSELCK_URL = '<?php echo CAROUSELCK_URL ?>';
...
<div id="ckfolderupload">
	<div class="inner">
		<div class="upload">
			...
			<p><?php echo JText::_( 'or Select Files' ); ?></p><input id="ckfileupload" type="file" class="" />
		</div>
	</div>
</div>
