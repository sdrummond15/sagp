...
<form action="<?php echo JRoute::_('index.php?option=com_carouselck&view=styles'.$appendUrl); ?>" method="post" name="adminForm" id="adminForm">
	<?php if ($isModal) { ?>
	<div id="ckheader">
		...
		<div class="ckheadermenu">
			<div class="ckheadertitle">CAROUSEL CK - <?php echo JText::_('CK_STYLES'); ?></div>
		</div>
	</div>
	...
	<table class="table table-striped" id="itemsList">
		...
		<tbody>
			...
			foreach ($this->items as $i => $item) :
				$link = 'index.php?option=com_carouselck&view=style&layout=modal&tmpl=component&id=' . $item->id;
	...
	<div>
		...
		<?php \Carouselck\CKFof::renderToken() ?>
	</div>
</form>