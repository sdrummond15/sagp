...
$doc->addScript(CAROUSELCK_MEDIA_URI . '/assets/ckbrowse.js');
...
function ckShowItems(btn, menutype, parentid) {
	...
	var myurl = "<?php echo JUri::base(true) ?>/index.php?option=com_carouselck&task=menus.ajaxShowMenuItems&" + cktoken + "=1";
	$ck.ajax({
		type: "POST",
		url: myurl,
		data: {
