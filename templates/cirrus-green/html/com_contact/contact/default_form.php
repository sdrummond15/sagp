...
<script>
	document.getElementById('contact-form').addEventListener('submit', function(event) {
		...
		if (typeof grecaptcha !== 'undefined') {
			grecaptcha.execute(); // o plugin já registrou sua site key
			// após o token ser gerado, o plugin vai submeter o form automaticamente
		} else {
			this.submit(); // fallback caso o grecaptcha não carregue
		}
	});
</script>
