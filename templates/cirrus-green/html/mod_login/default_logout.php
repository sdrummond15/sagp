...
<div id="btn-logout">
    ...
    <span><?php echo JText::_('JLOGOUT'); ?></span>

</div>

<div id="logout-box">

    <form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure', 0)); ?>" method="post" id="logout-form" class="form-vertical">
        ...
        <div class="logout-button">
            ...
            <input type="submit" name="Submit" class="btn-simple" value="<?php echo JText::_('JLOGOUT'); ?>"/>
